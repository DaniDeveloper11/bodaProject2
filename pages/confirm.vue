<template>
    <div class="flex flex-col  px-4 gap-4 my-10 w-screen text-brand-charcoal">
        ...
        <h1 data-tour="confirm-title" class="text-3xl font-dancing mb-4 text-brand-charcoal">{{ weddingConfig.texts.confirmPage.title }}</h1>
        ...
        <div data-tour="confirm-table" class="px-6 sm:px-6 lg:px-8 mx-auto">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    ...
                    <p class="mt-2 text-sm text-brand-charcoal/70">Favor de confirmar antes del <span class="font-semibold"> {{ weddingConfig.date.rsvpDeadline }}</span></p>
                </div>
            </div>
        ...
        <div data-tour="confirm-adults" class="mt-8 rounded-2xl border border-red-200 bg-red-50/60 px-5 py-4 max-w-lg">
            ...
            <a class="text-xs text-brand-cyan underline mt-1 inline-block" :href="weddingConfig.texts.confirmPage.adultsOnlyLink">
                ¿Por qué? →
            </a>
        </div>

        <div class="mt-6">
            <p class="text-brand-charcoal/70 text-sm">{{ weddingConfig.texts.confirmPage.footer }}</p>
            <p class="text-brand-charcoal/70 text-sm">{{ weddingConfig.texts.confirmPage.footerThanks }}</p>
        </div>
